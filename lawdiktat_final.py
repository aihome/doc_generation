...
def triggerfunction(file):
    convert(file,path2+"/generated documents/Downloadable File.pdf")
    
    with open(path2+"/Downloadable File.pdf", "rb") as pdf_file:
        PDFbyte = pdf_file.read()

    st.download_button(label="Download PDF", 
            data=PDFbyte,
            file_name="Your_Agreement.pdf",
...
def DistributorSupplierAgreement(path1, path2):
    ...
    st.markdown('<p class="font">DISTRIBUTOR SUPPLIER AGREEMENT</p>', unsafe_allow_html=True) 
    ...
    convert(path2+"/Supplier Distributor GeneratedR.docx",path2+"/Supplier Distributor GeneratedR.pdf")
    ...
    if st.button('Done editing'):
        triggerfunction(path2+"/Supplier Distributor Generated.docx")
...
def RentalAgreement(path1,path2):
    ...
    convert(path2+"/Rental Agreement GeneratedR.docx",path2+"/Rental Agreement GeneratedR.pdf")
    #convert("C:/Users/roysm/Documents/Alpha AI/Law Updated/generated documents/Supplier Distributor Generated.docx","C:/Users/roysm/Documents/Alpha AI/Law Updated/generated documents/Supplier Distributor Generated.pdf")
    f1=path2+'/Rental Agreement GeneratedR.pdf'

    if st.button('Done editing'):
        triggerfunction(path2+"/Rental Agreement Generated.docx")
...
def NonDisclosureAgreement(path1, path2):
    ...
    st.markdown('<p class="font">NON-DISCLOSURE AGREEMENT</p>', unsafe_allow_html=True)
    ...
    Year = st.sidebar.text_input("Enter the year (in the format 2022, 2021...):", value = 'Year')
    R_Name = st.sidebar.text_input("Name of the Registered Company:", value = 'Registered company Name')
    I_Name = st.sidebar.text_input("Name of the Incorporated Company:", value = 'Incorporated Company Name')
    ...
    convert(path2+"/NDA GeneratedR.docx",path2+"/NDA GeneratedR.pdf")
    f1 = path2+'/NDA GeneratedR.pdf'
    if st.button('Done editing'):
        triggerfunction(path2+"/NDA Generated.docx")
    displayPDF(f1)
...
def IndependentContractorAgreement(path1, path2):
    ...
    st.markdown('<p class="font">INDEPENDENT CONTRACTOR AGREEMENT</p>', unsafe_allow_html=True)
    ...
    convert(path2+"/Independent Contractor Agreement GeneratedR.docx",path2+"/Independent Contractor Agreement GeneratedR.pdf")
    f1=path2+'/Independent Contractor Agreement GeneratedR.pdf'

    if st.button('Done editing'):
        triggerfunction(path2+"/Independent Contractor Agreement Generated.docx")
...
def EmploymentContract(path1, path2):
    ...
    st.markdown('<p class="font">EMPLOYMENT CONTRACT</p>', unsafe_allow_html=True)
    ...
    convert(path2+"/Employment Contract GeneratedR.docx",path2+"/Employment Contract GeneratedR.pdf")
    f1=path2+'/Employment Contract GeneratedR.pdf'

    if st.button('Done editing'):
        triggerfunction(path2+"/Employment Contract Generated.docx")
...
def FoundersAgreement(path1, path2):
    ...
    st.markdown('<p class="font">FOUNDERS AGREEMENT</p>', unsafe_allow_html=True)
    ...
    convert(path2+"/Founders Agreement GeneratedR.docx",path2+"/Founders Agreement GeneratedR.pdf")
    f1=path2+'/Founders Agreement GeneratedR.pdf'

    if st.button('Done editing'):
        triggerfunction(path2+"/Founders Agreement Generated.docx")
...
def AgencyAgreement( path1, path2):
    ...
    convert(path2+"/Agency Agreement GeneratedR.docx",path2+"/Agency Agreement GeneratedR.pdf")
    f1=path2+"/Agency Agreement GeneratedR.pdf"

    if st.button('Done editing'):
        triggerfunction(path2+"/Agency Agreement Generated.docx")
...
def PromissoryNote(path1, path2):
    ...
    doc1.save(path2+"/PromissoryNotegenerated.docx")
    convert(path2+"/PromissoryNote_generatedR.docx",path2+"/PromissoryNote_generatedR.pdf")
    f1=path2+'/PromissoryNote_generatedR.pdf'

    if st.button('Done editing'):
        triggerfunction(path2+"/PromissoryNote_generated.docx")
...
def PropertySaleAgreement(path1, path2):
    ...
    st.markdown('<p class="font">PROPERTY SALE AGREEMENT</p>', unsafe_allow_html=True)
    ...
    convert(path2+"/Property sale agreement generatedR.docx",path2+"/Property sale agreement generatedR.pdf")
    f1=path2+'/Property sale agreement generatedR.pdf'

    if st.button('Done editing'):
        triggerfunction(path2+"/Property sale agreement generated.docx")
...
def GeneralServiceAgreement(path1, path2):
    ...
    st.markdown('<p class="font">GENERAL SERVICE AGREEMENT</p>', unsafe_allow_html=True)
    ...
    convert(path2+"/General Service agreement generatedR.docx",path2+"/General Service agreement generatedR.pdf")
    f1=path2+'/General Service agreement generatedR.pdf'

    if st.button('Done editing'):
        triggerfunction(path2+"/General Service agreement generated.docx")
    displayPDF(f1)
...
def SaleofGoodsAgreement(path1, path2):
    ...
    st.markdown('<p class="font">SALE OF GOODS AGREEMENT</p>', unsafe_allow_html=True)

    doc = DocxTemplate("C:/Users/roysm/Documents/Alpha AI/Law Updated/documents/Sale of Goods AgreementR.docx")
    doc1 = DocxTemplate("C:/Users/roysm/Documents/Alpha AI/Law Updated/documents/Sale of Goods Agreement.docx")
    context = {"Place": st.sidebar.text_input("Place:", value = "Place"),
    ...
    doc.render(context)
    doc1.render(context)
    doc.save("C:/Users/roysm/Documents/Alpha AI/Law Updated/generated documents/Sale of Goods generated AgreementR.docx")
    doc1.save("C:/Users/roysm/Documents/Alpha AI/Law Updated/generated documents/Sale of Goods generated Agreement.docx")
    convert("C:/Users/roysm/Documents/Alpha AI/Law Updated/generated documents/Sale of Goods generated AgreementR.docx","C:/Users/roysm/Documents/Alpha AI/Law Updated/generated documents/Sale of Goods generated AgreementR.pdf")
    f1='C:/Users/roysm/Documents/Alpha AI/Law Updated/generated documents/Sale of Goods generated AgreementR.pdf'

    if st.button('Done editing'):
        triggerfunction("C:/Users/roysm/Documents/Alpha AI/Law Updated/generated documents/Sale of Goods generated Agreement.docx")
    displayPDF(f1)
...
def Home(path1, path2):
    ...
    with instruct:
        ...
        st.markdown('<p class="font1">INSTRUCTIONS</p>', unsafe_allow_html=True)
        ...
        st.markdown('<p class="font">2. You must read the agreement and fill it in accordingly.</p>', unsafe_allow_html=True)
        ...
        st.markdown('<p class="font">4. Entered text will appear in red-colored texts in the preview box on your right.</p>', unsafe_allow_html=True)
        st.markdown('<p class="font">5. The input fields are Case-Sensetive.</p>', unsafe_allow_html=True)
        st.markdown('<p class="font">6. You may change the details if required.</p>', unsafe_allow_html=True)
        ...
        st.sidebar.markdown('<p class="font3"><b><u>DISCLAIMER</u></b></p>', unsafe_allow_html=True)
...
agreements = ['Home','Distributor Supplier Agreement', 'Rental Agreement', 'Non Disclosure Agreement', 'Independent Contractor Agreement', 'Employment Contract', 'Founders Agreement', 'Agency Agreement', 'Promissory Note', 'Property Sale Agreement','General Service Agreement','Sale of Goods Agreement']
