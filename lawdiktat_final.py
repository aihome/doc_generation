...
def DistributorSupplierAgreement(path1, path2):
    ...
    context = {"Place": st.sidebar.text_input("Place", value="Place", placeholder="Place"),
               ...
               "D_Address": st.sidebar.text_input("Distributor Registered at the Addrsess", value="Distributor Addrsess"),
...
def Home(path1, path2):
    ...
    with instruct:
        ...
        st.markdown(
            '<p class="font">4. Entered text will appear in between ( ) in bold and italic in the preview on your right.</p>', unsafe_allow_html=True)
        st.markdown(
